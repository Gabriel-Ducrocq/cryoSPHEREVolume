    ...
    for epoch in range(N_epochs):
        ...
        for batch_num, (indexes, original_images, batch_images, batch_poses, batch_poses_translation) in enumerate(data_loader):
            ...
            if grid_rotations is None:
                ...
                poses_min, reconstruction_errors, batch_predicted_images = pose_search.perform_pose_search(batch_translated_images_hartley, latent_mean, latent_std, experiment_settings, tracking_metrics, alms_per_coordinate, circular_mask, radius_indexes, ctf, use_ctf, grid_rotations, lmax, device)
            ...
            print("Wigner time", end_wigner - start_wigner)
            print("Applying Wigner", end_apply - start_apply)
