...
def perform_pose_search(batch_translated_images_hartley, latent_mean, latent_std, experiment_settings, tracking_metrics, alms_per_coordinates, circular_mask, radius_indexes, ctf, use_ctf, poses, lmax, device)
